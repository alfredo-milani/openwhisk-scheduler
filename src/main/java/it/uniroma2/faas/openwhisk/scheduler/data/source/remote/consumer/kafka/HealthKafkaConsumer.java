...
import it.uniroma2.faas.openwhisk.scheduler.data.source.domain.model.Health;
...
public class HealthKafkaConsumer extends AbstractKafkaConsumer<Health> {
    ...
    public HealthKafkaConsumer(@Nonnull List<String> topics, Properties kafkaProperties) {
        this(topics, kafkaProperties, DEFAULT_POLLING_INTERVAL_MS);
    }

    public HealthKafkaConsumer(@Nonnull List<String> topics, Properties kafkaProperties, int pollingIntervalMs) {
