...
import it.uniroma2.faas.openwhisk.scheduler.scheduler.BaseScheduler;
...
public class RunningCompositionSchedulerTest {
    ...
    public void whenReceivingCompositionActivation_PolicyAppliesCorrectly() throws Exception {
        ...
        final String activationRecord = "{\"action\": {\"name\": \"img_man\", \"path\": \"guest\", \"version\": \"0.0.2\"}, " +
                ...
                "\"userMemory\": 2048}, \"overload\": false, \"priority\": %d, \"target\": \"invoker1\", \"cmpLength\": 7}}, \"initArgs\": [], " +
        ...
        final Collection<BlockingCompletion> blockingCompletions = new ArrayList<>() {{
        ...
        final BaseScheduler baseScheduler = new BaseScheduler(policy, new ActivationKafkaProducerMock(kafkaProducerProperties));
        final RunningCompositionScheduler runningCompositionScheduler = new RunningCompositionScheduler(baseScheduler);
        runningCompositionScheduler.setRunningCompositionTimeLimitMs(60_000L);
        runningCompositionScheduler.setRunningCompositionsLimit(2);
        runningCompositionScheduler.setMaxBufferSize(100);
        
        runningCompositionScheduler.newEvent(ACTIVATION_STREAM, activations);
        runningCompositionScheduler.newEvent(COMPLETION_STREAM, blockingCompletions);
    }
